...
Felin and Holwig also emphasise that human beliefs are often grounded by theory-based causal logic. For example, although Galilao’s belief was not supported by the scientific consensus, it was connected to a causal theory for the movement of the stars. Felin and Holwig contrast this with AI systems that are typically designed to identify correlations within training data rather than formulate causal theories about that data. In short, the authors argue that AI models are inherently incapable of generating consistent theories about the world, given their inability to perform causal reasoning. <br>
