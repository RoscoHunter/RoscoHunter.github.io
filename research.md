...
<p style="font-size: 16px;">Worked under the supervision of Prof. Edmund Rolls (Oxford Centre of Computational Neuroscience) measuring effective connectivity in the human brain. Connectivity matrices were derived from a `Hopf Algorithm' composed of noisy coupled oscillators which modelled the cortical regions in the HCP multimodal parcellation atlas.</p>
