...
<p style="font-size: 16px;">Worked under the supervision of Prof. Edmund Rolls (h-index: 176) measuring the causal relationships between cortical areas by using a `Hopf Algorithm' composed of noisy coupled oscillators. Contributions to the refinement and explanation of the Hopf algorithm led to acknowledgments in several high-impact papers:
